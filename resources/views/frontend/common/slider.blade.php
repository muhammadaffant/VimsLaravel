    ...
    <div class="container">
        <div class="row justify-content-center justify-content-md-start">
            <div class="text col-12 col-md-8 text-center text-md-left d-flex flex-column justify-content-center py-5"><br><br>
                <h1 class="display-6 display-md-4 fw-bold mb-3" style="margin-top: 50px">Selamat Datang DI Viary Konveksi</h1>
                <p class="lead mb-3">{{ $slider->description }}</p>
                <a href="{{ route('user.customorder') }}" class="btn btn-primary btn-lg">Buat Sekarang</a>
            </div>
        </div>
    </div>
</div>
